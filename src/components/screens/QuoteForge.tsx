        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr", gap: 10 }}>
          ...
          >
            ...
            <div>
              ...
              <p style={{ color: "#888", fontSize: 13, fontFamily: "Source Sans 3", textTransform: "none", letterSpacing: "normal", margin: "2px 0 0" }}>
                Area-by-area walkthrough with conditions and photos. Inside any room, tap the Voice mic to record one continuous walk-through — Whisper transcribes, AI fills the checklist with conditions and notes.
              </p>
            </div>
          </div>
