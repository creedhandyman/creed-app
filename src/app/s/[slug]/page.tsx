    ...
    <div style={{ minHeight: "100vh", background: "#0a0a0f", color: "#e2e2e8" }}>
      ...
      <div style={{ background: "linear-gradient(135deg, #0d1530 0%, #0a0a0f 50%, #0d1020 100%)", padding: "60px 20px 50px", textAlign: "center" }}>
        ...
        <div style={{ display: "flex", gap: 12, justifyContent: "center", flexWrap: "wrap" }}>
          ...
          <a href={`/review?org=${org.id}`} style={{ padding: "12px 28px", borderRadius: 8, fontSize: 16, fontFamily: "Oswald, sans-serif", textTransform: "uppercase", background: "transparent", color: pc, textDecoration: "none", border: `1px solid ${pc}` }}>
            ⭐ Leave a Review
          </a>
        </div>
      </div>
